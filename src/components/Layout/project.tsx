...
const Project = () => {
  const data = [
    ...
    },
    {
      name: "Portofolio",
      description:
        "This is my first portfolio that I made by following the figma design with very good colors and placement",
      link: "https://github.com/irfanfirdaus/Project-1",
      icons: <MdModeOfTravel />,
      image: Project2,
      tech: ["HTML", "CSS", "Tailwind", "JavaScript"],
    ...
    },
    {
      name: "Website Travel",
      description:
        "for an even better experience in registering to climb the mountain without having to come to the counter",
      link: "https://github.com/irfanfirdaus/Project-1",
      icons: <MdModeOfTravel />,
      image: Project5,
      tech: ["HTML", "CSS", "Tailwind", "JavaScript"],
    ...
    <div
      ...
      <div className="flex flex-col items-center justify-center gap-32 pt-32">
        {data.map((item) => (
          <div
            key={item.name}
            className="flex flex-col md:flex-row justify-center items-center  p-5 rounded-xl shadow-2xl space-y-5 md:space-y-0 md:space-x-5"
            data-aos="fade-up"
